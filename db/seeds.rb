...
professionals_data = [
  { name: "Dr. Emily Carter", specialty: "Cardiology", time_zone: "America/New_York" },
  { name: "Dr. Michael Chen", specialty: "Physical Therapy", time_zone: "America/Chicago" },
  { name: "Dr. Jessica Davis", specialty: "Nutrition", time_zone: "America/Denver" },
  { name: "Dr. Christopher Rodriguez", specialty: "Psychology", time_zone: "America/Los_Angeles" },
  { name: "Dr. Sarah Miller", specialty: "Dermatology", time_zone: "America/New_York" },
  { name: "Dr. David Wilson", specialty: "Orthopedics", time_zone: "America/Chicago" },
  { name: "Dr. Laura Moore", specialty: "Gynecology", time_zone: "America/Los_Angeles" },
  { name: "Dr. James Taylor", specialty: "Ophthalmology", time_zone: "America/New_York" },
  { name: "Dr. Olivia Anderson", specialty: "Pediatrics", time_zone: "America/Phoenix" },
  { name: "Dr. Robert Thomas", specialty: "General Practice", time_zone: "America/Chicago" },
]

professionals_data.each do |data|
  Professional.find_or_create_by!(name: data[:name]) do |p|
    p.specialty = data[:specialty]
    p.time_zone = data[:time_zone]
  end
  print "."
end
